...
try:  # Optional dependency for Groq vision/OCR.
...
def _build_groq_client() -> Groq | None:  # type: ignore[valid-type]
    if not GROQ_API_KEY or Groq is None:
        return None
    return Groq(api_key=GROQ_API_KEY)


def _call_groq_for_scan(
    *,
    file_name: str | None,
    file_type: str | None,
    input_method: str,
...
def scan_homework_document(
    *,
    ...
    groq_result = _call_groq_for_scan(
        file_name=file_name,
        file_type=file_type,
